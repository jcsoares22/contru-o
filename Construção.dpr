...
uses
  ...
  CadastroUnidadeMedida
    in 'CadastroUnidadeMedida.pas' {frmCadastroUnidadeMedida} ,
  ...
  CadastroCondPagamento
    in 'CadastroCondPagamento.pas' {frmCadastroCondPagamento} ,
  ...
  CadastroTipoPagamento
    in 'CadastroTipoPagamento.pas' {frmCadastroTipoPagamento} ,
  ...
  CadastroRapidoCliente
    in 'CadastroRapidoCliente.pas' {frmCadastroRapidoCliente} ,
